...
class SupplierViewModel @Inject constructor(
    ...
    fun addSupplier(name: String, phone: String?, address: String?) {
        if (name.isBlank()) {
            viewModelScope.launch { _events.emit(SupplierEvent.ShowMessage("Nama pemasok wajib diisi")) }
            return
        }
        viewModelScope.launch { supplierRepository.addSupplier(name, phone, address) }
    }
    ...
    fun updateSupplier(supplier: SupplierEntity, name: String, phone: String?, address: String?) {
        ...
        viewModelScope.launch { supplierRepository.updateSupplier(supplier, name, phone, address) }
    }
