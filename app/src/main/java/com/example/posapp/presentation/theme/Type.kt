...
// Menggunakan font sistem default (tanpa font kustom) supaya APK tetap ringan,
// tapi dengan skala tipografi Material 3 penuh agar hierarki teks konsisten
// di semua layar (harga & total memakai weight lebih tebal untuk keterbacaan cepat).
